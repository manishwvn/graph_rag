...
graph LR
  ...
  E7 --> E8["Entry 8<br/>Honest Eval<br/>+ 29 tests"]
...
graph TD
  ...
  B6 --> A6
  B7 --> A7
  AFTER --> T["tests/test_graph_rag.py<br/>29 tests, one per defect"]
...
| `tests/test_graph_rag.py` | 29 tests, each named after the defect it prevents |
